...
namespace Vendor\Http\Resources;
...
abstract class ApiResource extends JsonResource
{
    ...
    protected static function createProperty(
        ...
        $keys     = ['key', 'description', 'type', 'format', 'ref', 'mutator', 'nullable'];
    ...
    protected static function propArray(
        ...
        return static::createProperty($key, $desc, 'array', null, null, $mutator, $nullable);
    }
